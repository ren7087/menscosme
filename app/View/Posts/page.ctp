                        ...
                        <div id="post-content" class="col-sm-12 blog-item mb60 wow fadeIn" data-wow-delay="0.5s">
                            <div class="row">
                                ...
                                <?php foreach ($posts as $post) :  ?>
                                    ...
                                    <br><p style="font-size: 20px;"><?php echo $post['Post']['body']; ?></p>
                                <?php endforeach ; ?>
                        ...
                        <div id="comments-list" class="col-xs-10 col-xs-offset-2 gap wow fadeIn" data-wow-delay="0.5s">
                                ...
                                <div class="media-body">
                                    <div class="well">
                                        <div class="media-heading">
                                            <span class="heading-font"><?php echo h($comment['username']); ?></span>&nbsp; <small><?php echo h($comment['created']); ?></small>
                                        </div>
                            ...
                            <div id="comments-form" class="row wow fadeIn" data-wow-delay="0.5s">
                                <div class="col-md-12">
                                    ...
                                    <?php echo $this->Form->input('body', array("class"=>"form-control", "required"=>true)); ?>
                                    <?php echo $this->Form->input("Comment.post_id", array("type"=>'hidden', 'value'=>$post['Post']['id'])); ?><br>
                                    <?php echo $this->Form->end("Reply", array("class"=>"btn btn-primary pull-right mt30")); ?>
                                </div>
                            </div>
                        </div>
                    </div>
